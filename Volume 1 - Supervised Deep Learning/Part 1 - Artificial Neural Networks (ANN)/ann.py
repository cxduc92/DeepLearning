...
# first hidden layer with 6 neurons, initialisation with uniform, activation functions is rectifier function
classifier.add(Dense(units = 6, kernel_initializer = 'uniform', activation = 'relu', input_dim = 10))

# Adding the second hidden layer
# second hidden layer with 6 neurons, initialisation with uniform, activation functions is rectifier function
